...
public class Valet
{
    ...
    Console.WriteLine("Your car has arrived");
        ...
        car1.MPG();
         int[] Car = {1,3,5};
    int sum1 = 0;
    foreach (int item in Car {
        sum1 += item;
        }
        Console.WriteLine("Car engine widths are: {0}",sum1);
    ...
    Console.WriteLine("Your truck has arrived");
        ...
        car2.MPG();
         int[] Truck = {2,4,7};
    int sum2 = 0;
    foreach (int item in Truck) {
        sum2 += item;
        }
        Console.WriteLine("Truck engine widths are: {0}",sum2);
    ...
    Console.WriteLine("Your van has arrived");
        ...
        int[] Van = {3,8,9};
    int sum3 = 0;
    foreach (int item in Van) {
        sum3 += item;
        }
        Console.WriteLine("Van engine widths are: {0}",sum3);
    }
}